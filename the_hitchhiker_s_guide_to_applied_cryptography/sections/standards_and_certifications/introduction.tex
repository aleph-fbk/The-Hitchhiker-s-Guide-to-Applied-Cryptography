...
\warningBlock{Watch out for conflicts}{Standards may sometimes conflict with each other. For instance, as of 2025, IETF RFC 8446 \cite{rfc8446} --- which defines \gls{tls} v1.3 (\Cref{sec:popular_protocols:tls}) --- considers ChaCha20-Poly1305 (\Cref{sec:symmetric_cryptography:ciphers:chacha20}) secure, while the \gls{nist} does not (yet).}
