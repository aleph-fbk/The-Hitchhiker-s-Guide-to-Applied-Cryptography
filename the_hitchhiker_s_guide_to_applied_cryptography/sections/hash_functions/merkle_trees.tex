...
Merkle trees are widely employed in distributed systems --- e.g., version control systems such as Git, blockchains,
%TODO (\Cref{future_sec:popular_applications:blockchain}), 
distributed peer-to-peer networks such as BitTorrent, and distributed databases such as Cassandra --- to ensure data integrity with minimal effort.
