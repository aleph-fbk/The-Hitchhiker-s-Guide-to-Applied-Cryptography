...
\warningBlock{The \gls{dl} problem vs. quantum computing}{Quantum computing can solve any \gls{dl} problem using the Shor's algorithm \cite{shor_algorithms_1994} in polynomial time (that is, efficiently) --- see \Cref{sec:TEMPORARY_LABEL:post_quantum_cryptography}.}
