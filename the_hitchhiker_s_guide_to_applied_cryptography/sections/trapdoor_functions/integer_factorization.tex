...
\warningBlock{The \gls{if} problem vs. quantum computing}{Quantum computing can solve the \gls{if} problem using the Shor's algorithm \cite{shor_algorithms_1994} in polynomial time (that is, efficiently) --- see \Cref{sec:TEMPORARY_LABEL:post_quantum_cryptography}.}
